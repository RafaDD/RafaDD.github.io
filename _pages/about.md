...
<div style="display: flex; align-items: center; padding: 10px; margin: 10px 0;">
    ...
    <div>
        <h3 style="margin: 0; font-size: 0.8em;">Shanghai Jiao Tong University</h3>
...
<div style="display: flex; align-items: center; padding: 10px; margin: 10px 0;">
    ...
    <div>
        <h3 style="margin: 0; font-size: 0.8em;">University of California San Diego</h3>
...
<div style="display: flex; align-items: center; padding: 10px; margin: 10px 0;">
    ...
    <div>
        <h3 style="margin: 0; font-size: 0.8em;">High School Affiliated to Nanjing Normal University</h3>
