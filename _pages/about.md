...
<div style="display: flex; align-items: center; padding: 10px; margin: 10px 0;">
    <img src="/images/sjtu.png" alt="Education Icon" style="width: 85px; height: 85px; margin-right: 10px; margin-bottom: 10px; object-fit: cover;">
    <div>
...
<div style="display: flex; align-items: center; padding: 10px; margin: 10px 0;">
    <img src="/images/nsfz.png" alt="Education Icon" style="width: 85px; height: 85px; margin-right: 10px; margin-bottom: 10px; object-fit: cover;">
    <div>
